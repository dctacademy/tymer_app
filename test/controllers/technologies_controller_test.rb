...
class TechnologiesControllerTest < ActionController::TestCase
  ...
  test "should create technology" do
    assert_difference('Technology.count') do
      post :create, technology: { name: @technology.name, technology_category_id: @technology.technology_category_id }
    end
  ...
  test "should update technology" do
    patch :update, id: @technology, technology: { name: @technology.name, technology_category_id: @technology.technology_category_id }
    assert_redirected_to technology_path(assigns(:technology))
  end
